...
public class DiningPhilosophers extends Application implements PhilosopherEventHandler {
    ...
    private HBox createCircles(Map<Integer, Circle> circleMap, Map<Integer, Text> textMap, Paint backgroundColor){
        HBox box = new HBox(10d); //her biri arasinda mesafe

        for (int i = 0; i <=5 ; i++) {
            //ust uste eleman koyma
            ...
            if (i == 1) {
                HBox.setMargin(stackPane, new Insets(0d,0d,0d,10d));
            }
        }
        return box;
    }
    ...
    public void start(Stage primaryStage) throws Exception
    {
        ...
        txtInfo.setFont(new Font(24d));

        Insets labelMargin = new Insets(10d);

        Label lbl1 = new Label("PHILOSOPHERS");
        lbl1.setFont(new Font(24d));
        VBox.setMargin(lbl1, labelMargin);

        Label lbl2 = new Label("FORKS");
        lbl2.setFont(new Font(24d));
        ...
        primaryStage.setScene(new Scene(root, 550d, 700d));
        primaryStage.show();
